...
function SuspendUnsuspendCommunity({
    searchValue,
    buttonsStatus,
    isSuspendedByAdmin,
}: {
    ...
    const {
        ...
        functionName: 'suspendCommunityByAdmin',
    ...
    const {
        ...
        functionName: 'unSuspendCommunityByAdmin',
        functionArgs: [searchValue],
        txValue: BigInt('0'),
    });
        ...
        <div className="cmcce3">
            ...
            {isUnSuspendButtonClicked && (
                <TxStatusModalReceipt
                    ...
                    isWriteError={isWriteErrorUnSuspendCommunity}
                    writeError={
                        writeErrorUnSuspendCommunity ? writeErrorUnSuspendCommunity : undefined
                    }
                    isLoading={isLoadingUnSuspendCommunity}
                    isSuccess={isSuccessUnSuspendCommunity}
