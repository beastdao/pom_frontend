            ...
            <Modal show={show} animation={false}>
                ...
                <Modal.Body>
                    {isPending ? (
                        ...
                        <>
                            <p>
                                RPC Node connection is unstable. Attempt to connect {errorCount}{' '}
                                Please wait...
                            </p>
                            <Spinner animation="border" variant="secondary" />
                        </>
                        ...
                        <p>
                            <b>Error:</b>{' '}
                            {txError && 'details' in txError && typeof txError.details === 'string'
                                ? txError.details
                                : 'An error occurred.'}
                        </p>
                    ) : isWriteError ? (
                        <p>
                            <b>Error:</b>{' '}
                            {writeError &&
                            'details' in writeError &&
                            typeof writeError.details === 'string'
                                ? writeError.details
                                : 'An error occurred.'}
                        </p>
                    ) : isLoading ? (
